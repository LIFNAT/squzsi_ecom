...
const products: Product[] = [
  { id: "beetroot", name: "Beetroot", sub: "(Local shop)", weight: "500 gm.", priceWhole: "17", priceDecimal: "29", emoji: "🍠" },
  { id: "avocado", name: "Italian Avocado", sub: "(Local shop)", weight: "500 gm.", priceWhole: "12", priceDecimal: "29", emoji: "🥑" },
  { id: "naan", name: "Szam amm", sub: "(Process food)", weight: "500 gm.", priceWhole: "14", priceDecimal: "29", emoji: "🫓" },
  { id: "beef", name: "Beef Mixed", sub: "(Cut Bone)", weight: "600 gm.", priceWhole: "16", priceDecimal: "29", emoji: "🥩" },
  { id: "sprite", name: "Cold drinks", sub: "(Sprite)", weight: "500 gm.", priceWhole: "18", priceDecimal: "29", emoji: "🥤" },
  { id: "plant-hunter", name: "Plant Hunter", sub: "(Frozen pack)", weight: "500 gm.", priceWhole: "20", priceDecimal: "29", emoji: "🌿" },
  { id: "carrot", name: "Deshi Gajor", sub: "(Local Carrot)", weight: "500 gm.", priceWhole: "19", priceDecimal: "29", emoji: "🥕" },
  { id: "cucumber", name: "Deshi Shosha", sub: "(Local Cucumber)", weight: "500 gm.", priceWhole: "04", priceDecimal: "29", emoji: "🥒" },
  { id: "chips", name: "Lays chips", sub: "(Bacon)", weight: "500 gm.", priceWhole: "21", priceDecimal: "29", emoji: "🍟" },
  { id: "cabbage", name: "Badhakopi", sub: "(Local Cabbage)", weight: "500 gm.", priceWhole: "09", priceDecimal: "29", emoji: "🥬" },
];
...
function ProductCard({ product }: { product: Product }) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-4 flex flex-col">
      <div className="bg-gray-50 rounded-xl h-32 flex items-center justify-center text-6xl mb-3">
        {product.emoji}
      </div>
      <div className="text-[15px] font-semibold text-gray-900 leading-snug">
        {product.name}{" "}
        <span className="font-normal text-gray-500">{product.sub}</span>
      </div>
    ...
    <div className="max-w-7xl mx-auto px-6 py-10  min-h-screen">
      ...
      <div className="grid grid-cols-3 sm:grid-cols-6 gap-3 mt-8">
        {categories.map((cat) => (
          <button
            key={cat.name}
            className="bg-white rounded-2xl border border-gray-100 p-4 flex flex-col items-start text-left hover:border-emerald-300 transition-colors"
          >
